...
#
module new one_bit_irrev_struct_end work:one_bit_irrev_struct_end:NOFILE -nosplit
...
load symbol shifting_block_end work:shifting_block_end:NOFILE HIERBOX pin amin input.left pin aplus input.left pin select0 input.left pin select1 input.left pin y output.right boxcolor 1 fillcolor 2 minwidth 13%
...
load inst sh shifting_block_end work:shifting_block_end:NOFILE -autohide -attr @cell(#000000) shifting_block_end -pg 1 -lvl 6 -y 1030
...
netloc Cout0_i__0_n_0 1 6 1 1490
...
netloc wiremux_11 1 4 2 1110 610 N
...
load net wiremux_15 -pin mux14 b -pin sh y
netloc wiremux_15 1 6 1 1490
...
netbloc @select 1 0 7 20 330 270 450 550 570 830 590 1090 830 1290 850 1510
levelinfo -pg 1 0 90 340 670 940 1180 1370 1560 1670 -top 0 -bot 1140
show
fullfit
#
# initialize ictrl to current module one_bit_irrev_struct_end work:one_bit_irrev_struct_end:NOFILE
ictrl init topinfo |
